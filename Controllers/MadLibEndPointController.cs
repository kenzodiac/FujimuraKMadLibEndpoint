...
//Mad Lib - Endpoint
//This is an API program done in C# that emulates the mini challenge we did during the combine of the same name where we fill out a MadLib story using user inputs
...
namespace FujimuraKMadLibEndpoint.Controllers;

[ApiController]
[Route("[controller]")]
public class MadLibEndPointController : ControllerBase
{
    [HttpGet]
